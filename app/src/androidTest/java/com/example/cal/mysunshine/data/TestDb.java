...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        if (rowId == -1) fail("Not a valid rowId, insert failed");
        ...
        TestUtilities.validateCurrentRecord("PROBLEM!", cursor, values);
    ...
    public void testWeatherTable() {
        ...
        TestUtilities.validateCurrentRecord("Problem in validation", cursor, weatherValues);
