 ...
 */
package com.example.cal.mysunshine.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case LOCATION: {
                numRows = db.delete(WeatherContract.LocationEntry.TABLE_NAME,
                        selection, selectionArgs);
                break;
            }
            default:
        ...
        if (numRows != 0) getContext().getContentResolver().notifyChange(uri, null);
    ...
    public int update(
        ...
        switch (match) {
            case WEATHER: {
                numRows = db.update(WeatherContract.WeatherEntry.TABLE_NAME, values,
                        selection, selectionArgs);
                break;
            }
            case LOCATION: {
                numRows = db.update(WeatherContract.LocationEntry.TABLE_NAME, values,
                        selection, selectionArgs);
                break;
            }
            default:
